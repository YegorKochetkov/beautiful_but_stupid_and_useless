...
export function Story() {
	...
	return (
		<section
			id="story"
			ref={sectionRef}
			className="relative h-[70dvh] min-h-fit w-screen overflow-hidden bg-bbsu-black-700 pt-12 text-bbsu-blue-50"
		>
			<div className="story-svg-background absolute inset-0 z-0 opacity-20">
				<BlobBackground />
			</div>
			<div className="relative z-10 flex size-full flex-col items-center gap-4 pb-12">
				...
				<p className="mt-16 max-w-2xl text-center text-xl leading-relaxed md:text-2xl">
					<span>
						...
						building connections that last, and creating a legacy
						that inspires. Our story is one of passion, innovation,
